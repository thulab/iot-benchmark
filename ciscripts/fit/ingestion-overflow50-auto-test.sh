...
mysql -A auto_test -h 166.111.7.145 -uroot -pIse_Nel_2017  -e "SELECT insertResult.*, configInsertInfo.version from insertResult  JOIN configInsertInfo USING(projectID)" | sed 's/\t/","/g;s/^/"/;s/$/"/;s/\n//g' > insertResult.csv
