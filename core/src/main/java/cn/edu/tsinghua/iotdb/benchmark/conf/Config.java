...
public class Config {
  ...
  /** TODO */
  private List<List<String>> THREAD_FILES;
  ...
  public List<List<String>> getTHREAD_FILES() {
    return THREAD_FILES;
  }

  public void setTHREAD_FILES(List<List<String>> THREAD_FILES) {
    this.THREAD_FILES = THREAD_FILES;
  }
}
