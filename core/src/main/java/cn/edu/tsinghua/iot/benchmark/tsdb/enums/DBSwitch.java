...
public enum DBSwitch {
  DB_IOT_140_REST(DBType.IoTDB, DBVersion.IOTDB_140, DBInsertMode.INSERT_USE_REST),
  DB_IOT_140_JDBC(DBType.IoTDB, DBVersion.IOTDB_140, DBInsertMode.INSERT_USE_JDBC),
  DB_IOT_140_SESSION_BY_TABLET(
      DBType.IoTDB, DBVersion.IOTDB_140, DBInsertMode.INSERT_USE_SESSION_TABLET),
  DB_IOT_140_SESSION_BY_RECORD(
      DBType.IoTDB, DBVersion.IOTDB_140, DBInsertMode.INSERT_USE_SESSION_RECORD),
  DB_IOT_140_SESSION_BY_RECORDS(
      DBType.IoTDB, DBVersion.IOTDB_140, DBInsertMode.INSERT_USE_SESSION_RECORDS),
