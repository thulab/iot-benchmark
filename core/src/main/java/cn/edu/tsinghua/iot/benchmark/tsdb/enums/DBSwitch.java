...
public enum DBSwitch {
  DB_IOT_130_TABLE_SESSION_BY_TABLET(
      DBType.IoTDB, DBVersion.IOTDB_130, DBInsertMode.INSERT_USE_TABLE_SESSION_TABLET),
  DB_IOT_130_TABLE_SESSION_BY_RECORD(
      DBType.IoTDB, DBVersion.IOTDB_130, DBInsertMode.INSERT_USE_TABLE_SESSION_RECORD),
