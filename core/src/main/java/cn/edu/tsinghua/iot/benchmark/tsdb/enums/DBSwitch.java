...
public enum DBSwitch {
  ...
  DB_DOLPHINDB_3_MTW(DBType.DolphinDB, DBVersion.DolphinDB_3, DBInsertMode.INSERT_USE_MTW),
  DB_DOLPHINDB_3_PTA(DBType.DolphinDB, DBVersion.DolphinDB_3, DBInsertMode.INSERT_USE_PTA),
  DB_DOLPHINDB_2_MTW(DBType.DolphinDB, DBVersion.DolphinDB_2, DBInsertMode.INSERT_USE_MTW),
  DB_DOLPHINDB_2_PTA(DBType.DolphinDB, DBVersion.DolphinDB_2, DBInsertMode.INSERT_USE_PTA),
