...
public class SendDataCustomizeConcurrencyThread4Rule extends Thread {
	static Logger logger = Logger.getLogger(SendDataCustomizeConcurrencyThread4Rule.class);
	 ...
	 * init parameters
	 */
	public SendDataCustomizeConcurrencyThread4Rule(String measurement, String metadataUid, String sendDataUid,
			...
			boolean needDetailsLog, int wrongRate) {
		super();
