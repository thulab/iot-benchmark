...
public class SendDataFixedConcurrencyThread extends Thread {
	static Logger logger = Logger.getLogger(SendDataFixedConcurrencyThread.class);
	...
	public SendDataFixedConcurrencyThread(String measurement, String metadataUid, String sendDataUid, String logLocation,
