...
public class AggValueQuery extends AggRangeQuery {
  ...
  private static final long timeStampConst = (config.TIMESTAMP_PRECISION.equals("ms")) ? 1L : 1000000L;
  private static final long timeRangeConst = (config.TIMESTAMP_PRECISION.equals("ms")) ? 1000L : 3L;
